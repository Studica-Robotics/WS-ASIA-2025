...
public final class XDrive {
  ...
  public static double speedY = 0.155 ;
  public static double speedZ = 0.11 ;

  public static double setpointDistanceY = 225; 
  public static double setpointDistanceZ = 300;

  public static double epsilonDistanceY = 50;
  public static double epsilonDistanceZ = 50;

  public static double ProtectDistance_Y = 275;
  ...
  public static int LEFT_BACK_LIDAR = -90 ; 
  public static int RIGHT_BACK_LIDAR = +90 ; 
  ...
  public static int FRONT_MAX_ANGLE_RIGHT = FRONT_LIDAR + 10; 
