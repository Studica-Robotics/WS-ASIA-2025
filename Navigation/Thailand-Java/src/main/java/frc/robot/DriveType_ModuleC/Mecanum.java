...
public final class Mecanum {
  ...
  public static double speedY = 0.18 ;
  ...
  public static double ProtectDistance_Left = 300;



  
  public static int FRONT_LIDAR = 90 ; 
  public static int LEFT_LIDAR = -45 ; 
  public static int RIGHT_LIDAR = +45 ;
  public static int LEFT_BACK_LIDAR = +180; 
  public static int RIGHT_BACK_LIDAR = +0 ;  


  public static int FRONT_MIN_ANGLE_LEFT = FRONT_LIDAR - 40 ; 
  public static int FRONT_MAX_ANGLE_LEFT = FRONT_LIDAR ; 
  public static int FRONT_MIN_ANGLE_RIGHT = FRONT_LIDAR ; 
  public static int FRONT_MAX_ANGLE_RIGHT = FRONT_LIDAR + 20 ; 
  ...
  public static int LEFT_PROTECT_MAX_ANGLE_RIGHT = FRONT_LIDAR + LEFT_BACK_LIDAR + 80 ; 
