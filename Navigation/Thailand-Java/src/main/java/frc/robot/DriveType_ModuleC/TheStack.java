...
public final class TheStack {
  ...
  public static double speedY = 0.159 ;
  public static double speedZ = 0.15 ;

  public static double setpointDistanceY = 300; 
  public static double setpointDistanceZ = 475;
  ...
  public static double ProtectDistance_Left = 375;

  
  public static int FRONT_LIDAR = 270 ; 
  public static int LEFT_LIDAR = -70 ; 
  public static int RIGHT_LIDAR = +70 ; 
  public static int LEFT_BACK_LIDAR = -135 ; 
  public static int RIGHT_BACK_LIDAR = +135 ; 


  public static int FRONT_MIN_ANGLE_LEFT = FRONT_LIDAR - 70 ; 
