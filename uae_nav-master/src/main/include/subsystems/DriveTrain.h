...
class DriveTrain : public frc2::SubsystemBase
{
    public:
        ...
        void StackMotorControl   (double x, double y, double z);
        void TwoWheelMotorControl(double x, double y, double z);
        void SixWheelMotorControl(double x, double y, double z);
        ...
        double prev_front_mean_dist, prev_left_mean_dist;


        int front_nan_count = 0;
        int robot_stuck_count = 0;
