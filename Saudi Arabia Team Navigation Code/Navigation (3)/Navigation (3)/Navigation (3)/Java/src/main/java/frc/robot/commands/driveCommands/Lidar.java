...
public class Lidar extends CommandBase {
    ...
    // ======================================================
    //  ROBOT DIMENSIONS RELATIVE TO LIDAR (in mm) lidar and front of robot
    // ======================================================
    ...
    // ======================================================
    //  FRONT SAFETY DISTANCE (distance from robot front) distance between robot and wall
    // ======================================================
    ...
    // ============================
    private static final double TURN_ANGLE_DEG  = 90.0;
